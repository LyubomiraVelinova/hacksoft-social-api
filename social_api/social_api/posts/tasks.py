...
#
# За автоматичното изтриване на "soft deleted" постове, можете да използвате Django management команда
# и plan за задачи (scheduler) като Celery. Във вашия план за задачи, постъпвайте по следния начин:
#
